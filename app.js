  ...
  tracks: [
    {
      ...
      // Lagu Indo Baru
      {
        id: 't_ku_gadikan_cintaku',
        title: 'Ku Gadikan Cintaku',
          artist: 'The Junas • 2020',
        durationHint: '',
        cover: ['#ffb300', '#7c4dff'],
        coverImg: 'assets/covers/ku-gadikan-cintaku.jpg',
        src: 'assets/audio/ku-gadikan-cintaku.mp3',
        lyricsLrc: 'assets/lyrics/ku-gadikan-cintaku.lrc',
        lyricsTxt: '',
        category: 'indo',
      },
      {
        id: 't_kota_ini_tanpamu',
        title: 'Kota Ini Tanpamu',
          artist: 'Ungu • 2015',
        durationHint: '',
        cover: ['#3949ab', '#ffb300'],
        coverImg: 'assets/covers/kota-ini-tanpamu.jpg',
        src: 'assets/audio/kota-ini-tanpamu.mp3',
        lyricsLrc: 'assets/lyrics/kota-ini-tanpamu.lrc',
        lyricsTxt: '',
        category: 'indo',
      },
      {
        ...
        durationHint: '',
        cover: ['#7c4dff', '#18d07f'],
        coverImg: 'assets/covers/ours-to-keep.jpg',
        src: 'assets/audio/ours-to-keep.mp3',
        lyricsLrc: 'assets/lyrics/ours-to-keep.lrc',
        lyricsTxt: '',
        category: 'indo',
      },
      {
        id: 't_payung_teduh_akad',
        title: 'Akad',
        artist: 'Payung Teduh • 2017',
        durationHint: '',
        cover: ['#ff5bb8', '#ffd600'],
        coverImg: 'assets/covers/payung-teduh-akad.jpg',
        src: 'assets/audio/payung-teduh-akad.mp3',
        lyricsLrc: 'assets/lyrics/payung-teduh-akad.lrc',
        lyricsTxt: '',
        category: 'indo',
      },
      {
        id: 't_fana_merah_jambu',
        title: 'Fana Merah Jambu',
          artist: 'Fourtwnty • 2018',
        durationHint: '',
        cover: ['#18d07f', '#ffb24c'],
        coverImg: 'assets/covers/fana-merah-jambu.jpg',
        src: 'assets/audio/fana-merah-jambu.mp3',
        lyricsLrc: 'assets/lyrics/fana-merah-jambu.lrc',
        lyricsTxt: '',
        category: 'indo',
      },
      {
        ...
        durationHint: '',
        cover: ['#7c4dff', '#ff1744'],
        coverImg: 'assets/covers/rumah-ke-rumah.jpg',
        src: 'assets/audio/rumah-ke-rumah.mp3',
        lyricsLrc: 'assets/lyrics/rumah-ke-rumah.lrc',
        lyricsTxt: '',
        category: 'indo',
      },
      {
        id: 't_dii_sarankan_di_bandung',
        title: 'Dii Sarankan di Bandung',
          artist: 'Efek Rumah Kaca • 2015',
        durationHint: '',
        cover: ['#ffd600', '#3949ab'],
        coverImg: 'assets/covers/dii-sarankan-di-bandung.jpg',
        src: 'assets/audio/dii-sarankan-di-bandung.mp3',
        lyricsLrc: 'assets/lyrics/dii-sarankan-di-bandung.lrc',
        lyricsTxt: '',
        category: 'indo',
      },
        {
          id: 't_syaidan',
            title: 'Syaidan',
            artist: 'Sabyan Gambus • 2018',
            durationHint: '',
            cover: ['#ffb300', '#18d07f'],
            coverImg: 'assets/covers/syaidan.jpg',
            src: 'assets/audio/syaidan.mp3',
            lyricsLrc: 'assets/lyrics/syaidan.lrc',
            lyricsTxt: '',
            category: 'indo',
          },
          {
            id: 't_everything_u_are',
            title: 'Everything U Are',
              artist: 'Hindia • 2018',
            durationHint: '',
            cover: ['#7c4dff', '#ffd600'],
            coverImg: 'assets/covers/everything-u-are.jpg',
            src: 'assets/audio/everything-u-are.mp3',
            lyricsLrc: 'assets/lyrics/everything-u-are.lrc',
            lyricsTxt: '',
            category: 'indo',
          },
          {
            id: 't_bulan_madu_di_awan_biru',
            title: 'Bulan Madu di Awan Biru',
            artist: 'Chrisye • 1988',
            durationHint: '',
            cover: ['#18d07f', '#ffb24c'],
            coverImg: 'assets/covers/bulan-madu-di-awan-biru.jpg',
            src: 'assets/audio/bulan-madu-di-awan-biru.mp3',
            lyricsLrc: 'assets/lyrics/bulan-madu-di-awan-biru.lrc',
            lyricsTxt: '',
            category: 'indo',
        },
    // Runway - English Song
    {
      ...
      {
        id: 't_sweet_but_psycho',
        title: 'Sweet But Psycho',
        artist: 'Ava Max • 2018',
        durationHint: '',
        cover: ['#ff5bb8', '#ffd600'],
        coverImg: 'assets/covers/sweet-but-psycho.jpg',
        src: 'assets/audio/sweet-but-psycho.mp3',
        lyricsLrc: 'assets/lyrics/sweet-but-psycho.lrc',
        lyricsTxt: '',
        category: 'english',
      },
      {
        id: 't_play_date',
        title: 'Play Date',
        artist: 'Melanie Martinez • 2015',
        durationHint: '',
        cover: ['#7c4dff', '#ffb24c'],
        coverImg: 'assets/covers/play-date.jpg',
        src: 'assets/audio/play-date.mp3',
        lyricsLrc: 'assets/lyrics/play-date.lrc',
        lyricsTxt: '',
        category: 'english',
      },
      {
        ...
        durationHint: '',
        cover: ['#18d07f', '#ff5bb8'],
        coverImg: 'assets/covers/doin-time.jpg',
        src: 'assets/audio/doin-time.mp3',
        lyricsLrc: 'assets/lyrics/doin-time.lrc',
        lyricsTxt: '',
        category: 'english',
        },
        {
          ...
          durationHint: '',
          cover: ['#90caf9', '#ffd600'],
          coverImg: 'assets/covers/snowman.jpg',
          src: 'assets/audio/snowman.mp3',
          lyricsLrc: 'assets/lyrics/snowman.lrc',
          lyricsTxt: '',
          category: 'english',
          },
          {
            id: 't_kings_and_queens',
            title: 'Kings & Queens',
            artist: 'Ava Max • 2020',
            durationHint: '',
            cover: ['#7c4dff', '#ffb24c'],
            coverImg: 'assets/covers/kings-and-queens.jpg',
            src: 'assets/audio/kings-and-queens.mp3',
            lyricsLrc: 'assets/lyrics/kings-and-queens.lrc',
            lyricsTxt: '',
            category: 'english',
            },
            {
              id: 't_genius',
              title: 'Genius',
              artist: 'LSD (Labrinth, Sia, Diplo) • 2018',
              durationHint: '',
              cover: ['#ffd600', '#7c4dff'],
              coverImg: 'assets/covers/genius.jpg',
              src: 'assets/audio/genius.mp3',
              lyricsLrc: 'assets/lyrics/genius.lrc',
              lyricsTxt: '',
              category: 'english',
              },
              {
                id: 't_sweater_weather',
                title: 'Sweater Weather',
                artist: 'The Neighbourhood • 2013',
                durationHint: '',
                cover: ['#90caf9', '#ffb24c'],
                coverImg: 'assets/covers/sweater-weather.jpg',
                src: 'assets/audio/sweater-weather.mp3',
                lyricsLrc: 'assets/lyrics/sweater-weather.lrc',
                lyricsTxt: '',
                category: 'english',
                },
                {
                  id: 't_under_the_influence',
                  title: 'Under The Influence',
                  artist: 'Chris Brown • 2019',
                  durationHint: '',
                  cover: ['#ff5bb8', '#3949ab'],
                  coverImg: 'assets/covers/under-the-influence.jpg',
                  src: 'assets/audio/under-the-influence.mp3',
